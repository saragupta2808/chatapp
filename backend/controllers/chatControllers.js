...
//for creating or accessing a one-on-one chat
const accessChat = asyncHandler(async(req,res)=>{
    //usedId with which you want to chat
    //if a chat with this userId exists then send that chat or else create a new chat
    const {userId} = req.body;
    if(!userId){
        console.log('UserId params not found in request body.')
        res.sendStatus(400);
    }
    //checking whether chat exists with this user
